...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-us" lang="en-us">
  <head>
    ...
    <title>Currency Sum Graph</title>
  ...
  <body>
  <div class="container">
      <h1 class="page-header text-center">Currency Sum Graph</h1>
        <div id="currencySumChart"></div>
      <div style="margin-top:30px"></div>
      <p class="text-info text-center">
          <small>
              <strong>Graph presents summarize volume of processed financial data for appropriate currencies</strong>
          </small>
      </p>
      <div style="margin-top:30px"></div>
  ...
  <script type="text/javascript" src='<spring:url value="/resources/js/websocket/currencySum.js" />'></script>
